const { ZERO, ONE, BRIDGE_MIN_LENGTH, BRIDGE_MAX_LENGTH, UP, DOWN, RESTART, QUIT } = require('../constants/consition');
...
const ERROR_MESSAGE = Object.freeze({
  ...
  invalidRandomNumber: `[ERROR] 다리 칸을 생성하기 위해서는 ${ZERO} 또는 ${ONE}이어야 합니다..\n`,
});
